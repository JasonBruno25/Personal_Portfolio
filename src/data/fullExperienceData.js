// We need to make sure that I do this most recent to latest
export const allExperiences = [
    {
        // NOTE: Make sure to add about the fast that I did sell items, used the cash register, and sold protection, and credit cards, and other such stuff
        ...
        bullets: [
            ...
            "Maintained warehouse organization and asset protection standards by identifying inventory discrepancies, securing high-shrink products, and following company loss-prevention procedures",
            "Operated warehouse equipment and handled merchandise weighing up to 100 pounds while consistently following safety procedures and maintaining a clean, organized work environment",
            "Assisted with store operational duties including inventory preparation, shipment processing, display maintenance, and completion of daily, clean and bright, responsibilities"
        ]
    },
    {
        company: "Virginia Tech",
        location: "Blacksburg, VA",
        position: "Building Services Student Assistant | Virginia Tech Libraries",
        ...
        bullets: [
            ...
            "Assisted with operational and logistical projects requiring physical labor, attention to detail, and coordination across multiple departments within the library system",
            "Contributed to efficient facility operations by helping monitor storage areas, organizing supplies, and supporting opening and closing procedures when needed"
        ]
    },
    {
        company: "Mina Incorporated",
    ...
    },
    {
        ...
        bullets: [
            "Provided hands-on technical and operational support for tax preparation staff in a fast-paced production environment during peak tax season",
            "Installed, configured, and maintained Windows-based systems and Drake Tax software to ensure reliable and secure workstation functionality",
            "Assisted with software updates, system patching, malware prevention, and troubleshooting of technical issues affecting office productivity",
            "Supported tax preparation operations by reviewing, organizing, scanning, and processing client documentation and tax-related records",
    ...
    },
    {
        ...
        bullets: [
            ...
            "Followed company safety procedures, asset protection policies, and operational standards while handling merchandise and operating within fast-paced warehouse environments",
            "Assisted with store preparation for inventory counts and operational projects while maintaining a clean, organized, and safety-focused workspace"
        ]
    },
    {
        company: "Fairfax County Park Authority",
        location: "Reston, VA",
        position: "Supervisor | Water Mine Family Swimmin' Hole",
        ...
        bullets: [
            ...
            "Conducted Vigilance Awareness Training (VAT), spot checks, and staff performance evaluations to maintain lifeguard readiness and compliance with Ellis & Associates standards",
            "Assisted with staffing coordination, onboarding support, and employee performance management while helping maintain proper staffing levels throughout operating hours",
            "Coordinated with admissions and operations teams to ensure efficient park flow, smooth guest experiences, and timely response to operational issues",
            "Maintained professional communication and customer service standards while effectively handling difficult situations, large crowds, and fast-paced operational demands",
            "Performed lifeguarding duties as required while maintaining CPR, first aid, and emergency response certifications"
        ]
    },
    {
        company: "Fairfax County Park Authority",
        location: "Chantilly, VA",
        position: "Headguard | Cub Run Rec Center",
        period: "September 2015 - April 2016",
        bullets: [
            "Supervised lifeguards during assigned shifts and supported the daily operation of a public aquatic recreation facility focused on guest and safety and operational efficiency",
            "Directed and guided lifeguards in surveillance responsibilities, emergency preparedness, cleaning procedures, and customer service expectations",
            "Ensured the health and safety of guests through active pool surveillance, enforcement of facility policies, and compliance with local health and safety regulations",
            "Conducted and documented operational inspections of pool areas, locker rooms, rescue equipment, and aquatic systems to ensure facility readiness and safety compliance",
            "Monitored and maintained pool water chemistry while communicating operational concerns or irregularities to supervisors and management staff",
            "Responded to emergency situations and administered first aid, rescue care, and emergency procedures as needed for guests and staff",
            "Participated in mandatory in-service training programs and maintained rescue and lifeguarding skills at test-ready standards through ongoing certification and drills",
            "Assisted with operational cleaning and maintenance duties involving pool decks, locker rooms, equipment storage areas, and surrounding facility spaces",
            "Delivered professional customer service by assisting guests with facility concerns, operational questions, and general support requests",
            "Maintained CPR, first aid, and emergency response certifications while supporting safe and professional aquatic operations"
        ]
    },
    {
        company: "Fairfax County Park Authority",
        location: "Reston, VA",
        position: "Assistant Supervisor | Water Mine Family Swimmin' Hole",
        ...
        bullets: [
            ...
            "Delivered strong customer service while helping resolve guest concerns and supporting smooth day-to-day operations during high-attendance periods",
            "Performed lifeguarding responsibilities as needed while maintaining CPR, first aid, and emergency response certifications",
            "Demonstrated leadership, adaptability, and decision-making skills in a fast-paced recreational environment requiring continuous operational awareness"
        ]
    },
    {
        company: "Fairfax County Park Authority",
        location: "Chantilly, VA",
        position: "Lifeguard | Cub Run Rec Center",
        period: "September 2014 - May 2015",
        bullets: [
            "Ensured the health and safety of guests through continuous pool surveillance, enforcement of aquatic facility rules, and adherence to Ellis & Associates safety standards",
            "Performed water rescue, emergency response procedures, and first aid treatment for guests and staff during emergency situations both in and out of water",
            "Maintained lifeguarding, CPR, and first aid skills at test-ready levels through mandatory in-service training, emergency drills, and monthly staff meetings",
            "Assisted with daily cleaning and maintenance of pool decks, locker rooms, aquatic equipment, guest areas and surrounding facility spaces",
            "Provided professional customer service by assisting guests with questions, locker issues, lost-and-found concerns, and general operational support",
            "Participated in special event setup, breakdown, and operational support activities within the aquatic facility",
            "Maintained a professional attitude and appearance while supporting a safe, clean, and welcoming environment for guests and staff",
            "Assisted supervisors and park staff with additional operational duties and site activities as needed"
        ]
    },
    {
        company: "Fairfax County Park Authority",
        location: "Reston, VA",
        position: "Lifeguard | Water Mine Family Swimmin' Hole",
        period: "May 2014 - September 2014",
        bullets: [
            "Monitored aquatic attractions and  guest activity to ensure safety through active surveillance, enforcement of park policies, and rapid emergency response procedures",
            "Performed water rescues, administered first aid, and provided emergency care to guests in distress both in and outside of aquatic environments",
